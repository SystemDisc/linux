...
static const struct dcp_method_entry dcp_methods[dcpep_num_methods] = {
	...
	IOMFB_METHOD("A034", dcpep_update_notify_clients_dcp),
	...
	IOMFB_METHOD("A419", dcpep_get_gamma_table),
	IOMFB_METHOD("A422", iomfbep_set_matrix),
	IOMFB_METHOD("A423", dcpep_set_contrast),
	...
	IOMFB_METHOD("A427", iomfbep_set_brightness_correction),
};
...
static const iomfb_cb_handler cb_handlers[IOMFB_MAX_CB] = {
	...
	[101] = trampoline_get_display_default_stride,
	[102] = trampoline_set_number_property,
	...
	[120] = dcpep_cb_boot_1,
	[121] = dcpep_cb_d121_or_boot_1, /* is_dark_boot, or firmware 14.x start_hardware_boot */
	...
	[127] = trampoline_prop_chunk_or_start,
	[128] = trampoline_prop_end_or_chunk,
	[129] = trampoline_allocate_bandwidth_or_prop_end,
	...
	[208] = trampoline_update_backlight_factor_prop,
	...
	[552] = trampoline_set_property_dict, /* set_property_dict_0 */
	[561] = trampoline_set_property_dict,
	[563] = trampoline_set_property_int,
	[565] = trampoline_set_property_bool,
	...
	[581] = trampoline_swap_complete_head_of_line,
	[582] = trampoline_create_default_fb_surface,
	...
	[590] = trampoline_batched_swap_complete_ap_gated,
